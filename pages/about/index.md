...
* [Flow](http://amzn.to/2inl3w8) by Mihaly Csikszentmihalyi and [Deep Work](http://amzn.to/2AvNLTG) by Cal Newport ([notes](https://www.robinwieruch.de/lessons-learned-deep-work-flow/))
* [Give and Take](http://amzn.to/2olhgRv) by Adam Grant ([notes](https://www.robinwieruch.de/lessons-learned-give-and-take/))
...
* powerful monitoring
* [hosting of multiple projects and websites](https://www.robinwieruch.de/deploy-applications-digital-ocean)
...
Every developer needs an IDE or editor/terminal combination. I like to have multiple tools, by having each tool for a specific purpose, but combining them to one great developer experience. That's why I am using Sublime Text and iTerm. If you want to know how to set it up, you can find more about it over here: [a developer's setup](https://www.robinwieruch.de/developer-setup/).
