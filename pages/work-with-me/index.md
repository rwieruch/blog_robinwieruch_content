...
categories: ["React", "Redux", "JavaScript", "Growth", "Machine Learning", "Web Development"]
...
I want to continue teaching others. So far, I have written two ebooks about [learning React with advanced state management such as Redux and MobX](https://leanpub.com/u/rwieruch), published articles in print magazines, got more ebooks about Firebase and GraphQL in the pipeline, and launched a [platform to help people learn React](https://roadtoreact.com). By shifting my life to being self-employed, I hope I can gather enough resources to lift this endeavour to the next level. In addition, I count on all the support I get from you to keep going with it. The community in React and general JavaScript is a great inspiration for me and motivates me to keep going. It would mean a lot to me if I could continue teaching others and keep learning myself.
...
* [Favesound](http://www.favesound.de)
* [Open Crowd Found](https://github.com/rwieruch/open-crowd-fund)
* [Purchasing Parity Power](https://github.com/rwieruch/purchasing-power-parity)
* [Lots of other projects can be found on Github!](https://github.com/rwieruch)
