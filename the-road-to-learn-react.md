...
card = "img/posts/the-road-to-learn-react/cover_640.png"
...
{{% package_box "The Road to learn React" "Build a Hacker News App along the way. No setup configuration. No tooling. No Redux. Plain React in 170+ pages of learning material. Pay as you want like <strong>11.000+ readers</strong>." "Get the Book" "img/page/cover.png" "https://www.getrevue.co/profile/rwieruch" %}}
...
<div class="col-md-12">
  <div class="col-md-8" style="margin-top: 30px;">
    <ul>
      ...
      <li>implementation of client-side caching</li>
