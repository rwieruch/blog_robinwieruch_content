...
*Note: To access the environment variables in your source code, install and add the {{% a_blank "dotenv package" "https://github.com/motdotla/dotenv" %}} as described in this [setup tutorial](https://www.robinwieruch.de/minimal-node-js-babel-setup/).*
