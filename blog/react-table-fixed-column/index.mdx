...
We fixed to columns to the left side. You can fix columns the same way to the right side as well. What's missing is giving the Cell components a `pin` prop to signalize them to stick to the side:
